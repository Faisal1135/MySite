  ...
  <div>
    ...
    >
      ...
      <p
        ...
        style="transform: translateY(30px)"
      >
        Standing Alone In an Unknown Universe
      </p>
      <a
        id="viewWorkBtn"
        href="/"
...
import galibImage from '~/assets/galib.jpeg';
...
export default {
  mounted() {
    ...
    const spaceTexture = new TextureLoader().load(spaceImage);
    ...
    generatePlane()
      ...
      // Galib Texture
    const galibTexture = new TextureLoader().load(galibImage);

      const galib = new Mesh(
